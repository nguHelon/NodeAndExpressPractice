...
const CreateListing = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        if (+formData.regularPrice < +formData.discountPrice) return setError('Discout price must be less than regular price')
        setLoading(true);
        setError(false);
    ...
    <main className="p-3 max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex flex-wrap gap-6">
                    <div className="flex items-center gap-2">
                        <input 
                            ...
                            max="10" 
                            required 
                            className="p-3 borde border-gray-300 rounded-lg"
                            onChange={handleChange}
            ...
            <div className="flex flex-col flex-1 gap-4">
                ...
                <p className="text-red-700 text-sm">{setImageUploadError && imageUploadError}</p>
                {                    
